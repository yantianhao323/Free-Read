...
import me.ash.reader.domain.service.RuleSyncWorker
import me.ash.reader.domain.service.CleanupWorker
...
class AndroidApp : Application(), Configuration.Provider {
    ...
    private suspend fun workerInit() {
        ...
        RuleSyncWorker.enqueuePeriodicWork(workManager)
        CleanupWorker.enqueuePeriodic(workManager)
