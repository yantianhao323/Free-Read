...
interface ArticleDao {
    ...
    /**
     * Query the latest articles from a specific account, ordered by date descending.
     * Used by BypassPrefetcher for auto-prefetch.
     */
    @Query(
        """
        SELECT * FROM article
    ...
    suspend fun queryLatestByAccount(accountId: Int, limit: Int = 90): List<Article>
